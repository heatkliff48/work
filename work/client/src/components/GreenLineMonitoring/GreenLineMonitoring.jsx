...
const GreenLineMonitoring = () => {
  ...
  const fetchAvailableDates = async () => {
    try {
      setLoading(true);
      const response = await api.get('/greenlinemonitoring/dates/available');
  ...
  const fetchSensorData = async (date) => {
    try {
      ...
      const response = await api.get('/greenlinemonitoring/data/by-date', {
        params: { date },
      });
              ...
              <div className="sensor-stats">
                <div className="stat-item">
                  ...
                  <span className="stat-value">
                    {stats.min_height?.toFixed(2)} mm
                  </span>
                </div>
                <div className="stat-item">
                  <span className="stat-label">Avg.</span>
                  <span className="stat-value">
                    {stats.average_height?.toFixed(2)} mm
                  </span>
                </div>
                <div className="stat-item">
                  <span className="stat-label">Max.</span>
                  <span className="stat-value">
                    {stats.max_height?.toFixed(2)} mm
                  </span>
                </div>
                <div className="stat-item">
...
export default GreenLineMonitoring;
