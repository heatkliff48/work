...
import { ClientContext } from './ClientsInfo';

import ClientsAddress from "../ClientsAddress/ClientsAddress";
//import ShowClientsAddressModal from "./ClientsAddressModal";
        ...
        <Container>
          ...
          <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/3">
                <h3 className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-client">
            ...
            <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/3">
                <label className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-tin">
                  TIN:
                </label>
              </div>
            ...
            <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/3">
                <label className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-category">
                  Category:
                </label>
              </div>
              <div className="md:w-2/3">
