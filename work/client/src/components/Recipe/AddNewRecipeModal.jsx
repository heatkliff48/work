...
function AddNewRecipeModal({ show, onHide }) {
  ...
  const raw_material_aluminum_1 = useSelector(
    (state) => state.warehouseAluminum1,
  );
  ...
  const alum1Options = useMemo(() => {
    if (!raw_material_aluminum_1) return [];

    const uniqueTypes = [
      ...new Set(raw_material_aluminum_1.map((item) => item.type)),
    ];
  ...
  const addRecipeHandler = async () => {
    ...
    console.log(
      updatedRecipeInput,
      'updatedRecipeInput AddNewRecipeModal.jsx line 259',
    );
  ...
  useEffect(() => {
    console.log(recipeInput, 'recipeInput AddNewRecipeModal.jsx line 290');
  }, [recipeInput]);
                  ...
                  <Col>
                    {recipe_info.map((el) => {
                      if (
                        ...
                        return null;
                      else if (el.accessor === 'aluminum_paste') {
                        return (
                          <div className="md:flex md:items-center mb-6">
                            <div className="md:w-1/3">
                              ...
                              <Select
                                options={alum1Options}
                                value={
                                  alum1Options.find(
                                    (opt) =>
                                      opt.value === recipeInput?.aluminum_type,
                                  ) || null
                                }
                                onChange={(option) =>
                                  setRecipeInput((prev) => ({
                                    ...prev,
                                    aluminum_type: option?.value,
                                  }))
                                }
                      ...
                      } else if (el.accessor === 'aluminum_paste_2') {
                        return (
                          <div className="md:flex md:items-center mb-6">
                            <div className="md:w-1/3">
                              <label
                              ...
                              <Select
                                ...
                                value={
                                  alum1Options.find(
                                    (opt) =>
                                      opt.value ===
                                      recipeInput?.aluminum_2_type,
                                  ) || null
                                }
                                onChange={(option) =>
                                  setRecipeInput((prev) => ({
                                    ...prev,
                                    aluminum_2_type: option?.value,
                                  }))
                                }
                                placeholder="Select type..."
                                isClearable={false}
