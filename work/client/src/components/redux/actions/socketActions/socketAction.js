...
export const newStatusWarehouseManagerTrailerSocket = (wh_trailer) => {
  return {
    type: NEW_STATUS_WAREHOUSE_MANAGER_TRAILER_SOCKET,
    payload: wh_trailer,
  };
};

export const deleteWarehouseManagerTrailerSocket = (wh_trailer) => {
  return {
