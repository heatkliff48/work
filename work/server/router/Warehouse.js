...
router.get('/reserved/anchor', WarehouseController.getListOfReservedAnchorProducts);
...
router.post('/autoclave_calendares/add', WarehouseController.addNewAutoclaveCalendarData);
router.get(
...
router.post('/upd/quantitys/tool', WarehouseController.updateToolWarehouseQuantitys);
router.post(
...
router.post('/reserved/drymix/upd', WarehouseController.updReservedDryMixedProducts);
router.post(
...
router.post('/reserved/anchor/upd', WarehouseController.updReservedAnchorProducts);
router.post(
  '/reserved/anchor/delete',
  WarehouseController.deleteReservedAnchorProducts
);

router.post('/reserved/tool/add', WarehouseController.addNewReservedToolProducts);
router.post('/reserved/tool/upd', WarehouseController.updReservedToolProducts);
router.post('/reserved/tool/delete', WarehouseController.deleteReservedToolProducts);

router.post(
  '/reserved/relmat/add',
  WarehouseController.addNewReservedRelMatProducts
);
router.post('/reserved/relmat/upd', WarehouseController.updReservedRelMatProducts);
router.post(
